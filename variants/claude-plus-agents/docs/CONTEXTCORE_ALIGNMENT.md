...
| `handoff.*` | `/projects/*/handoffs/HANDOFF-*.md` (claude-plus-agents only) | `handoff.id`, `handoff.from_agent`, `handoff.to_agent`, `handoff.from_role`, `handoff.to_role`, `handoff.status` |
...
| `projects/*/handoffs/HANDOFF-*.md` | `HandoffManager` record |
