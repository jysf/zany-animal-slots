...
- [ ] SPEC-007 (build) — 5×3 spin resolver: given seed/strips, produce the visible grid (draw order reel 0→4). **[S]**
...
**Count:** 2 shipped / 0 active / 5 pending — sized at Stage Frame (5×S, 2×M; no L). All small/medium, one concern each.
