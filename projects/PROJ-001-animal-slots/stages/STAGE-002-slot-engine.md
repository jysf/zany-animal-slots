...
- [ ] SPEC-008 (build) — Payline + paytable evaluation: 5 fixed lines (DEC-003), 3/4/5-of-a-kind per tier (DEC-011), sum of all line wins. **[M]**
...
**Count:** 3 shipped / 0 active / 4 pending — sized at Stage Frame (5×S, 2×M; no L). All small/medium, one concern each.
