...
- [~] SPEC-032 (verify) — **Contrast + 44px audit & fixes**: WCAG AA contrast audit (1 fix — lighten `--_raw-muted` so muted-on-frame button text clears 4.5:1) + ≥44px confirmed; both locked by guard tests. **[M]**
